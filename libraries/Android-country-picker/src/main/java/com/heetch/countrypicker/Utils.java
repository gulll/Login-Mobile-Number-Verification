...
public class Utils {
    ...
    public static List<Country> parseCountries(Context pContext,JSONObject jsonCountries) {
        ...
        while (iter.hasNext()) {
            ...
            try {
                ...
                countries.add(new Country(key, value,new Locale(pContext.getResources().getConfiguration().locale.getLanguage(),
                        key).getDisplayCountry() ));
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
